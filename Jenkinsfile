        ...
        stage ('Deploy') {
            ...
            steps {
                sshagent(credentials: ['cloudlab']) {
                    ...
                    sh 'scp -r -v -o StrictHostKeyChecking=no *.yml AustinH@76.99.243.169:~/'
                    sh 'ssh -o StrictHostKeyChecking=no AustinH@76.99.243.169 kubectl apply -f /users/lngo/deployment.yml -n jenkins'
                    sh 'ssh -o StrictHostKeyChecking=no AustinH@76.99.243.169 kubectl apply -f /users/lngo/service.yml -n jenkins'                                        
                }
            }
        }
    }
